...
async function getStaticProps() {
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://milanmino:Slavko-1994@cluster0.s22mjyv.mongodb.net/meetups?retryWrites=true&w=majority");
  const db = client.db();
